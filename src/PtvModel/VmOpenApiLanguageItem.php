 ...
 */
class VmOpenApiLanguageItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VmOpenApiLanguageItem';
    ...
    */
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling VmOpenApiLanguageItem., must be bigger than or equal to 1.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) < 1)) {
            throw new \InvalidArgumentException('invalid length for $language when calling VmOpenApiLanguageItem., must be bigger than or equal to 1.');
        }
