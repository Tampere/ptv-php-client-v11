 ...
 */
class V11VmOpenApiServiceLocationChannelIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V11VmOpenApiServiceLocationChannelIn';
    ...
    */
    ...
    public function setSourceId($sourceId)
    {
        ...
        if (!is_null($sourceId) && (!preg_match("/^[A-Za-z0-9-.]*$/", $sourceId))) {
            throw new \InvalidArgumentException("invalid value for \$sourceId when calling V11VmOpenApiServiceLocationChannelIn., must conform to the pattern /^[A-Za-z0-9-.]*$/.");
        }
    ...
    public function setOid($oid)
    {
        ...
        if (!is_null($oid) && (!preg_match("/^[A-Za-z0-9.-]*$/", $oid))) {
            throw new \InvalidArgumentException("invalid value for \$oid when calling V11VmOpenApiServiceLocationChannelIn., must conform to the pattern /^[A-Za-z0-9.-]*$/.");
        }
    ...
    public function setOrganizationId($organizationId)
    {
        ...
        if ((mb_strlen($organizationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $organizationId when calling V11VmOpenApiServiceLocationChannelIn., must be bigger than or equal to 1.');
        }
    ...
    public function setPublishingStatus($publishingStatus)
    {
        ...
        if ((mb_strlen($publishingStatus) < 1)) {
            throw new \InvalidArgumentException('invalid length for $publishingStatus when calling V11VmOpenApiServiceLocationChannelIn., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param bool|null $deleteAllSupportPhones Set to true to delete all existing support phones for the service channel. The SupportPhones collection should be empty when this property is set to true.
     *
     * @return self
     */
