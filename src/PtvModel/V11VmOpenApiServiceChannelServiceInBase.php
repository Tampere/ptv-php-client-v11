 ...
 */
class V11VmOpenApiServiceChannelServiceInBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V11VmOpenApiServiceChannelServiceInBase';
    ...
    */
    ...
    public function setServiceId($serviceId)
    {
        ...
        if ((mb_strlen($serviceId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $serviceId when calling V11VmOpenApiServiceChannelServiceInBase., must be bigger than or equal to 1.');
        }
