...
/**
 * V11VmOpenApiElectronicChannelInBase Class Doc Comment
 *
 * @category Class
 ...
 */
class V11VmOpenApiElectronicChannelInBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V11VmOpenApiElectronicChannelInBase';
    ...
    */
    ...
    public function setSourceId($sourceId)
    {
        ...
        if (!is_null($sourceId) && (!preg_match("/^[A-Za-z0-9-.]*$/", $sourceId))) {
            throw new \InvalidArgumentException("invalid value for \$sourceId when calling V11VmOpenApiElectronicChannelInBase., must conform to the pattern /^[A-Za-z0-9-.]*$/.");
        }
    ...
    public function setSignatureQuantity($signatureQuantity)
    {
        ...
        if (!is_null($signatureQuantity) && (!preg_match("/^[1-9]\\d*$/", $signatureQuantity))) {
            throw new \InvalidArgumentException("invalid value for \$signatureQuantity when calling V11VmOpenApiElectronicChannelInBase., must conform to the pattern /^[1-9]\\d*$/.");
        }
     ...
     *
     * @param string|null $publishingStatus Service channel publishing status. Values: Draft, Published, Deleted or Modified.
     *
     * @return self
     */
