 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V11VmOpenApiElectronicChannelInBase implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'V11VmOpenApiElectronicChannelInBase';
...
'publishingStatus' => 'getPublishingStatus'    ];
    ...
    {
        return isset($this->container['signatureQuantity']) ? $this->container['signatureQuantity'] : null;
    }

    /**
     * Sets signatureQuantity
     *
     * @param string $signatureQuantity How many signatures are required (number). Required if RequiresSignature is true.
     *
     * @return $this
     */
    ...
    {
        return isset($this->container['requiresSignature']) ? $this->container['requiresSignature'] : null;
    }

    /**
     * Sets requiresSignature
     *
     * @param bool $requiresSignature Signature required.
     *
     * @return $this
     */
    ...
    {
        return isset($this->container['requiresAuthentication']) ? $this->container['requiresAuthentication'] : null;
    }
     ...
     *
     * @param bool $deleteAllAttachments Set to true to delete all existing attachments. The attachments collection should be empty when this property is set to true.
     *
     * @return $this
     */
     ...
     *
     * @param string[] $requiredPropertiesAvailableLanguages Internal property to check the languages within required lists: ServiceChannelNames, ServiceChannelDescriptions,  WebPage and AccessibilityClassification lists.
     *
     * @return $this
     */
