...
/**
 * V8VmOpenApiOrganizationItem Class Doc Comment
 *
 * @category Class
 ...
 */
class V8VmOpenApiOrganizationItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V8VmOpenApiOrganizationItem';
