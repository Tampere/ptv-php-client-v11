 ...
 */
class V9VmOpenApiEntrance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V9VmOpenApiEntrance';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('isMainEntrance', $data ?? [], null);
        $this->setIfExists('coordinates', $data ?? [], null);
        $this->setIfExists('accessibilitySentences', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLanguageItem[]|null $name List of localized service names.
     *
     * @return self
     */
     ...
     * Sets isMainEntrance
     *
     * @param bool|null $isMainEntrance Indicates if entrance is main entrance.
     *
     * @return self
     */
    public function setIsMainEntrance($isMainEntrance)
    {
        if (is_null($isMainEntrance)) {
            throw new \InvalidArgumentException('non-nullable isMainEntrance cannot be null');
        }
     ...
     * Gets coordinates
     *
     * @return \Tampere\PtvV11\PtvModel\VmOpenApiCoordinates|null
     */
     ...
     * Sets coordinates
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiCoordinates|null $coordinates coordinates
     *
     * @return self
     */
     ...
     *
     * @return \Tampere\PtvV11\PtvModel\VmOpenApiAccessibilitySentence[]|null
     */
     ...
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiAccessibilitySentence[]|null $accessibilitySentences List of accessibility sentences.
     *
     * @return self
     */
    public function setAccessibilitySentences($accessibilitySentences)
    {
        if (is_null($accessibilitySentences)) {
            array_push($this->openAPINullablesSetToNull, 'accessibilitySentences');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('accessibilitySentences', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets contactInfo
     *
     * @return \Tampere\PtvV11\PtvModel\VmOpenApiAccessibilityContactInfo|null
     */
     ...
     * Sets contactInfo
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiAccessibilityContactInfo|null $contactInfo contactInfo
     *
     * @return self
     */
