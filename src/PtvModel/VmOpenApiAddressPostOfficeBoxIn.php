 ...
 */
class VmOpenApiAddressPostOfficeBoxIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VmOpenApiAddressPostOfficeBoxIn';
    ...
    */
    ...
    public function setMunicipality($municipality)
    {
        ...
        if (!is_null($municipality) && (!preg_match("/^[0-9]{1,3}$/", $municipality))) {
            throw new \InvalidArgumentException("invalid value for \$municipality when calling VmOpenApiAddressPostOfficeBoxIn., must conform to the pattern /^[0-9]{1,3}$/.");
        }
    ...
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling VmOpenApiAddressPostOfficeBoxIn., must be bigger than or equal to 1.');
        }
