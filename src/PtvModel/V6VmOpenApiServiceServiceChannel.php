...
/**
 * V6VmOpenApiServiceServiceChannel Class Doc Comment
 *
 * @category Class
 ...
 */
class V6VmOpenApiServiceServiceChannel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V6VmOpenApiServiceServiceChannel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('serviceChannel', $data ?? [], null);
    ...
    */
     ...
     * Sets serviceChannel
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiItem|null $serviceChannel serviceChannel
     *
     * @return self
     */
    public function setServiceChannel($serviceChannel)
    {
        if (is_null($serviceChannel)) {
            throw new \InvalidArgumentException('non-nullable serviceChannel cannot be null');
        }
