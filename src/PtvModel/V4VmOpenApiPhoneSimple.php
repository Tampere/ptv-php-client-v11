 ...
 */
class V4VmOpenApiPhoneSimple implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V4VmOpenApiPhoneSimple';
    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling V4VmOpenApiPhoneSimple., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d{1,20}$/", $number))) {
            throw new \InvalidArgumentException("invalid value for \$number when calling V4VmOpenApiPhoneSimple., must conform to the pattern /^\\d{1,20}$/.");
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) < 1)) {
            throw new \InvalidArgumentException('invalid length for $language when calling V4VmOpenApiPhoneSimple., must be bigger than or equal to 1.');
        }
