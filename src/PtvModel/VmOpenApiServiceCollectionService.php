 ...
 */
class VmOpenApiServiceCollectionService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VmOpenApiServiceCollectionService';
