 ...
 */
class VmOpenApiAttachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VmOpenApiAttachment';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VmOpenApiAttachment., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 150)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VmOpenApiAttachment., must be smaller than or equal to 150.');
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 500)) {
            throw new \InvalidArgumentException('invalid length for $url when calling VmOpenApiAttachment., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling VmOpenApiAttachment., must be bigger than or equal to 1.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) < 1)) {
            throw new \InvalidArgumentException('invalid length for $language when calling VmOpenApiAttachment., must be bigger than or equal to 1.');
        }
