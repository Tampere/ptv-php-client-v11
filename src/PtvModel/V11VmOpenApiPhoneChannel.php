 ...
 */
class V11VmOpenApiPhoneChannel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V11VmOpenApiPhoneChannel';
    ...
    */
    ...
    public function setSourceId($sourceId)
    {
        ...
        if (!is_null($sourceId) && (!preg_match("/^[A-Za-z0-9-.]*$/", $sourceId))) {
            throw new \InvalidArgumentException("invalid value for \$sourceId when calling V11VmOpenApiPhoneChannel., must conform to the pattern /^[A-Za-z0-9-.]*$/.");
        }
     ...
     * Sets phoneNumbers
     *
     * @param \Tampere\PtvV11\PtvModel\V4VmOpenApiPhoneWithType[]|null $phoneNumbers List of phone numbers for the service channel.
     *
     * @return self
     */
