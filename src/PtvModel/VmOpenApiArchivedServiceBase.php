...
/**
 * VmOpenApiArchivedServiceBase Class Doc Comment
 *
 * @category Class
 * @description Model
 * @package  Tampere\PtvV11
 ...
 */
class VmOpenApiArchivedServiceBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VmOpenApiArchivedServiceBase';
    ...
    */
     ...
     * Sets archivingDate
     *
     * @param \DateTime|null $archivingDate Archiving date (utc).
     *
     * @return self
     */
    public function setArchivingDate($archivingDate)
    {
        if (is_null($archivingDate)) {
            throw new \InvalidArgumentException('non-nullable archivingDate cannot be null');
        }
     ...
     * Sets serviceNames
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLocalizedListItem[]|null $serviceNames Service names.
     *
     * @return self
     */
