 ...
 */
class V7VmOpenApiFintoItemWithDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V7VmOpenApiFintoItemWithDescription';
