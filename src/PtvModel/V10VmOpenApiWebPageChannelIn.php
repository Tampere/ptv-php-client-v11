 ...
 */
class V10VmOpenApiWebPageChannelIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V10VmOpenApiWebPageChannelIn';
    ...
    */
    ...
    public function setSourceId($sourceId)
    {
        ...
        if (!is_null($sourceId) && (!preg_match("/^[A-Za-z0-9-.]*$/", $sourceId))) {
            throw new \InvalidArgumentException("invalid value for \$sourceId when calling V10VmOpenApiWebPageChannelIn., must conform to the pattern /^[A-Za-z0-9-.]*$/.");
        }
    ...
    public function setOrganizationId($organizationId)
    {
        ...
        if ((mb_strlen($organizationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $organizationId when calling V10VmOpenApiWebPageChannelIn., must be bigger than or equal to 1.');
        }
    ...
    public function setPublishingStatus($publishingStatus)
    {
        ...
        if ((mb_strlen($publishingStatus) < 1)) {
            throw new \InvalidArgumentException('invalid length for $publishingStatus when calling V10VmOpenApiWebPageChannelIn., must be bigger than or equal to 1.');
        }
