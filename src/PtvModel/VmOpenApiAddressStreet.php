...
/**
 * VmOpenApiAddressStreet Class Doc Comment
 *
 * @category Class
 ...
 */
class VmOpenApiAddressStreet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VmOpenApiAddressStreet';
    ...
    */
    ...
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling VmOpenApiAddressStreet., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/\\d{5}?/", $postalCode))) {
            throw new \InvalidArgumentException("invalid value for \$postalCode when calling VmOpenApiAddressStreet., must conform to the pattern /\\d{5}?/.");
        }
    ...
    public function setStreetNumber($streetNumber)
    {
        ...
        if (!is_null($streetNumber) && (mb_strlen($streetNumber) > 30)) {
            throw new \InvalidArgumentException('invalid length for $streetNumber when calling VmOpenApiAddressStreet., must be smaller than or equal to 30.');
        }
