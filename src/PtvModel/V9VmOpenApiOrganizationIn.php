...
/**
 * V9VmOpenApiOrganizationIn Class Doc Comment
 *
 * @category Class
 ...
 */
class V9VmOpenApiOrganizationIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V9VmOpenApiOrganizationIn';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['organizationType'] === null) {
            $invalidProperties[] = "'organizationType' can't be null";
        }
        if ((mb_strlen($this->container['organizationType']) < 1)) {
            $invalidProperties[] = "invalid value for 'organizationType', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['organizationNames'] === null) {
            $invalidProperties[] = "'organizationNames' can't be null";
        }
        if ($this->container['organizationDescriptions'] === null) {
            $invalidProperties[] = "'organizationDescriptions' can't be null";
        }
    ...
    public function setSourceId($sourceId)
    {
        ...
        if (!is_null($sourceId) && (!preg_match("/^[A-Za-z0-9-.]*$/", $sourceId))) {
            throw new \InvalidArgumentException("invalid value for \$sourceId when calling V9VmOpenApiOrganizationIn., must conform to the pattern /^[A-Za-z0-9-.]*$/.");
        }
    ...
    public function setBusinessCode($businessCode)
    {
        ...
        if (!is_null($businessCode) && (!preg_match("/^[0-9]{7}-[0-9]{1}$/", $businessCode))) {
            throw new \InvalidArgumentException("invalid value for \$businessCode when calling V9VmOpenApiOrganizationIn., must conform to the pattern /^[0-9]{7}-[0-9]{1}$/.");
        }
    ...
    public function setOid($oid)
    {
        ...
        if (!is_null($oid) && (mb_strlen($oid) > 100)) {
            throw new \InvalidArgumentException('invalid length for $oid when calling V9VmOpenApiOrganizationIn., must be smaller than or equal to 100.');
        }
        if (!is_null($oid) && (!preg_match("/^\\d+\\.\\d+\\.\\d+\\.\\d+\\.\\d+\\.\\d+\\.\\d+$/", $oid))) {
            throw new \InvalidArgumentException("invalid value for \$oid when calling V9VmOpenApiOrganizationIn., must conform to the pattern /^\\d+\\.\\d+\\.\\d+\\.\\d+\\.\\d+\\.\\d+\\.\\d+$/.");
        }
    ...
    public function setMunicipality($municipality)
    {
        ...
        if (!is_null($municipality) && (!preg_match("/^[0-9]{1,3}$/", $municipality))) {
            throw new \InvalidArgumentException("invalid value for \$municipality when calling V9VmOpenApiOrganizationIn., must conform to the pattern /^[0-9]{1,3}$/.");
        }
    ...
    public function setOrganizationType($organizationType)
    {
        ...
        if ((mb_strlen($organizationType) < 1)) {
            throw new \InvalidArgumentException('invalid length for $organizationType when calling V9VmOpenApiOrganizationIn., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLocalizedListItem[] $organizationDescriptions Localized list of organization descriptions. Possible type values are: Description, Summary.
     *
     * @return self
     */
     ...
     *
     * @param string $publishingStatus Publishing status (Draft or Published).
     *
     * @return self
     */
    public function setPublishingStatus($publishingStatus)
    {
        ...
        if ((mb_strlen($publishingStatus) < 1)) {
            throw new \InvalidArgumentException('invalid length for $publishingStatus when calling V9VmOpenApiOrganizationIn., must be bigger than or equal to 1.');
        }
