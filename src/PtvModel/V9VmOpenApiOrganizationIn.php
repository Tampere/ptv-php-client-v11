 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V9VmOpenApiOrganizationIn implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'V9VmOpenApiOrganizationIn';
...
'deleteAllElectronicInvoicings' => 'getDeleteAllElectronicInvoicings'    ];
    ...
    {
        return isset($this->container['subAreaType']) ? $this->container['subAreaType'] : null;
    }
    ...
    {
        return isset($this->container['deleteAllElectronicInvoicings']) ? $this->container['deleteAllElectronicInvoicings'] : null;
    }
