 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VmOpenApiAddressStreetWithCoordinates implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VmOpenApiAddressStreetWithCoordinates';
...
'coordinateState' => 'getCoordinateState'    ];
     ...
     *
     * @param string $coordinateState State of coordinates. Coordinates are fetched from a service provided by Maanmittauslaitos (WFS).  Possible values are: Loading, Ok, Failed, NotReceived, EmptyInputReceived, MultipleResultsReceived, WrongFormatReceived or EnteredByUser.
     *
     * @return $this
     */
