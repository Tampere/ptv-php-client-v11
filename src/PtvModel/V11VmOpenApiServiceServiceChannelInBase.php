 ...
 */
class V11VmOpenApiServiceServiceChannelInBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V11VmOpenApiServiceServiceChannelInBase';
    ...
    */
    ...
    public function setServiceChannelId($serviceChannelId)
    {
        ...
        if ((mb_strlen($serviceChannelId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $serviceChannelId when calling V11VmOpenApiServiceServiceChannelInBase., must be bigger than or equal to 1.');
        }
