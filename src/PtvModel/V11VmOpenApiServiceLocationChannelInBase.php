 ...
 */
class V11VmOpenApiServiceLocationChannelInBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V11VmOpenApiServiceLocationChannelInBase';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('deleteAllPhoneNumbers', $data ?? [], null);
        $this->setIfExists('deleteAllFaxNumbers', $data ?? [], null);
        $this->setIfExists('deleteOid', $data ?? [], null);
    ...
    */
    ...
    public function setSourceId($sourceId)
    {
        ...
        if (!is_null($sourceId) && (!preg_match("/^[A-Za-z0-9-.]*$/", $sourceId))) {
            throw new \InvalidArgumentException("invalid value for \$sourceId when calling V11VmOpenApiServiceLocationChannelInBase., must conform to the pattern /^[A-Za-z0-9-.]*$/.");
        }
     ...
     * Sets oid
     *
     * @param string|null $oid Service channel OID. Must match the regex @\"^[A-Za-z0-9.-]*$\".  NOTICE! At the moment the property is only a placeholder. The data is not saved into database!
     *
     * @return self
     */
    public function setOid($oid)
    {
        ...
        if (!is_null($oid) && (!preg_match("/^[A-Za-z0-9.-]*$/", $oid))) {
            throw new \InvalidArgumentException("invalid value for \$oid when calling V11VmOpenApiServiceLocationChannelInBase., must conform to the pattern /^[A-Za-z0-9.-]*$/.");
        }
     ...
     * Sets supportEmails
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLanguageItem[]|null $supportEmails List email addresses for the service channel.
     *
     * @return self
     */
     ...
     * Sets faxNumbers
     *
     * @param \Tampere\PtvV11\PtvModel\V4VmOpenApiPhoneSimple[]|null $faxNumbers Service location contact fax numbers.
     *
     * @return self
     */
     ...
     * Gets addresses
     *
     * @return \Tampere\PtvV11\PtvModel\V9VmOpenApiAddressLocationIn[]|null
     */
     ...
     * Sets addresses
     *
     * @param \Tampere\PtvV11\PtvModel\V9VmOpenApiAddressLocationIn[]|null $addresses List of service location addresses.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $deleteAllSupportEmails Set to true to delete emails. The email property should be empty when this property is set to true.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $deleteAllPhoneNumbers Set to true to delete phone number. The prohone property should be empty when this property is set to true.
     *
     * @return self
     */
    public function setDeleteAllPhoneNumbers($deleteAllPhoneNumbers)
    {
        if (is_null($deleteAllPhoneNumbers)) {
            throw new \InvalidArgumentException('non-nullable deleteAllPhoneNumbers cannot be null');
        }
     ...
     *
     * @param bool|null $deleteAllFaxNumbers Set to true to delete fax number. The fax property should be empty when this property is set to true.
     *
     * @return self
     */
     ...
     * Sets deleteOid
     *
     * @param bool|null $deleteOid Set to true to delete OID. The Oid property should be empty when this property is set to true.
     *
     * @return self
     */
    public function setDeleteOid($deleteOid)
    {
        if (is_null($deleteOid)) {
            throw new \InvalidArgumentException('non-nullable deleteOid cannot be null');
        }
     ...
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLocalizedListItem[]|null $serviceChannelNames List of organization names. Possible type values are: Name, AlternativeName.
     *
     * @return self
     */
     ...
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiNameTypeByLanguage[]|null $displayNameType List of Display name types (Name or AlternativeName) for each language version of ServiceChannelNames.
     *
     * @return self
     */
     ...
     * Sets phoneNumbers
     *
     * @param \Tampere\PtvV11\PtvModel\V4VmOpenApiPhone[]|null $phoneNumbers List of support phone numbers for the service channel.
     *
     * @return self
     */
    ...
    public function setPublishingStatus($publishingStatus)
    {
        ...
        if ((mb_strlen($publishingStatus) < 1)) {
            throw new \InvalidArgumentException('invalid length for $publishingStatus when calling V11VmOpenApiServiceLocationChannelInBase., must be bigger than or equal to 1.');
        }
