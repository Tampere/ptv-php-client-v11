...
/**
 * V11VmOpenApiPrintableFormChannel Class Doc Comment
 *
 * @category Class
 ...
 */
class V11VmOpenApiPrintableFormChannel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V11VmOpenApiPrintableFormChannel';
    ...
    protected static $openAPITypes = [
        ...
        'deliveryAddresses' => '\Tampere\PtvV11\PtvModel\V8VmOpenApiAddressDelivery[]',
    ...
    */
    ...
    public function setSourceId($sourceId)
    {
        ...
        if (!is_null($sourceId) && (!preg_match("/^[A-Za-z0-9-.]*$/", $sourceId))) {
            throw new \InvalidArgumentException("invalid value for \$sourceId when calling V11VmOpenApiPrintableFormChannel., must conform to the pattern /^[A-Za-z0-9-.]*$/.");
        }
     ...
     * Sets formIdentifier
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLanguageItem[]|null $formIdentifier List of localized form identifier. One per language.
     *
     * @return self
     */
     ...
     *
     * @return \Tampere\PtvV11\PtvModel\V8VmOpenApiAddressDelivery[]|null
     */
     ...
     *
     * @param \Tampere\PtvV11\PtvModel\V8VmOpenApiAddressDelivery[]|null $deliveryAddresses Form delivery addresses.
     *
     * @return self
     */
     ...
     * Sets channelUrls
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLocalizedListItem[]|null $channelUrls List of localized channel urls.
     *
     * @return self
     */
