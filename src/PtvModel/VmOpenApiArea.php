...
/**
 * VmOpenApiArea Class Doc Comment
 *
 * @category Class
 ...
 */
class VmOpenApiArea implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VmOpenApiArea';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the area. Possible values are: Municipality, Region, BusinessSubRegion, HospitalDistrict, WellbeingServiceCounties.  In version 7 and older: Municipality, Province, BusinessRegions, HospitalRegions.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code Code of the area.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLanguageItem[]|null $name Localized list of names for the area
     *
     * @return self
     */
     ...
     * Sets municipalities
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiMunicipality[]|null $municipalities List of municipalities including municipality code and a localized list of municipality names.
     *
     * @return self
     */
