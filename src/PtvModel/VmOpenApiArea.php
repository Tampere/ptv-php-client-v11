 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VmOpenApiArea implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VmOpenApiArea';
...
'ownerReferenceId' => 'getOwnerReferenceId'    ];
     ...
     * Sets type
     *
     * @param string $type Type of the area. Possible values are: Municipality, Region, BusinessSubRegion, HospitalDistrict.  In version 7 and older: Municipality, Province, BusinessRegions, HospitalRegions.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLanguageItem[] $name Localized list of names for the area
     *
     * @return $this
     */
     ...
     * Sets municipalities
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiMunicipality[] $municipalities List of municipalities including municipality code and a localized list of municipality names.
     *
     * @return $this
     */
