 ...
 */
class V9VmOpenApiAddressIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V9VmOpenApiAddressIn';
    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (!preg_match("/^[A-Z]{2}$/", $country))) {
            throw new \InvalidArgumentException("invalid value for \$country when calling V9VmOpenApiAddressIn., must conform to the pattern /^[A-Z]{2}$/.");
        }
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling V9VmOpenApiAddressIn., must be bigger than or equal to 1.');
        }
    ...
    public function setSubType($subType)
    {
        ...
        if ((mb_strlen($subType) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subType when calling V9VmOpenApiAddressIn., must be bigger than or equal to 1.');
        }
