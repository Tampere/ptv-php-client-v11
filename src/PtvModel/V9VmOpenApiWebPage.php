...
/**
 * V9VmOpenApiWebPage Class Doc Comment
 *
 * @category Class
 ...
 */
class V9VmOpenApiWebPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V9VmOpenApiWebPage';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 500)) {
            throw new \InvalidArgumentException('invalid length for $url when calling V9VmOpenApiWebPage., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling V9VmOpenApiWebPage., must be bigger than or equal to 1.');
        }
    ...
    public function setValue($value)
    {
        ...
        if (!is_null($value) && (mb_strlen($value) > 100)) {
            throw new \InvalidArgumentException('invalid length for $value when calling V9VmOpenApiWebPage., must be smaller than or equal to 100.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) < 1)) {
            throw new \InvalidArgumentException('invalid length for $language when calling V9VmOpenApiWebPage., must be bigger than or equal to 1.');
        }
     ...
     * Sets orderNumber
     *
     * @param int|null $orderNumber The order of web pages.
     *
     * @return self
     */
