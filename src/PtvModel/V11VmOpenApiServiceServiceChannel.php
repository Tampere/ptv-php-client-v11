 ...
 */
class V11VmOpenApiServiceServiceChannel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V11VmOpenApiServiceServiceChannel';
