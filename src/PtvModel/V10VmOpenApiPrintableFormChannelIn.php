 ...
 */
class V10VmOpenApiPrintableFormChannelIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V10VmOpenApiPrintableFormChannelIn';
    ...
    protected static array $openAPINullables = [
		...
		'services' => true,
		'deleteAllDeliveryAddresses' => false,
		'deleteAllChannelUrls' => false,
		'deleteAllAttachments' => false,
		'deleteAllSupportEmails' => false,
		'deleteAllSupportPhones' => false,
		'deleteAllFormIdentifiers' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('formIdentifier', $data ?? [], null);
        $this->setIfExists('deliveryAddresses', $data ?? [], null);
        ...
        $this->setIfExists('channelUrls', $data ?? [], null);
        ...
        $this->setIfExists('deleteAllDeliveryAddresses', $data ?? [], null);
        $this->setIfExists('deleteAllChannelUrls', $data ?? [], null);
        ...
        $this->setIfExists('deleteAllFormIdentifiers', $data ?? [], null);
    }
    ...
    */
    ...
    public function setSourceId($sourceId)
    {
        ...
        if (!is_null($sourceId) && (!preg_match("/^[A-Za-z0-9-.]*$/", $sourceId))) {
            throw new \InvalidArgumentException("invalid value for \$sourceId when calling V10VmOpenApiPrintableFormChannelIn., must conform to the pattern /^[A-Za-z0-9-.]*$/.");
        }
     ...
     * Sets formIdentifier
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLanguageItem[]|null $formIdentifier List of localized form identifiers. One per language. (Max.Length: 100).
     *
     * @return self
     */
    public function setFormIdentifier($formIdentifier)
    {
        if (is_null($formIdentifier)) {
            array_push($this->openAPINullablesSetToNull, 'formIdentifier');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('formIdentifier', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @return \Tampere\PtvV11\PtvModel\V8VmOpenApiAddressDeliveryIn[]|null
     */
     ...
     *
     * @param \Tampere\PtvV11\PtvModel\V8VmOpenApiAddressDeliveryIn[]|null $deliveryAddresses Gets or sets the delivery addresses.
     *
     * @return self
     */
    public function setDeliveryAddresses($deliveryAddresses)
    {
        if (is_null($deliveryAddresses)) {
            array_push($this->openAPINullablesSetToNull, 'deliveryAddresses');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('deliveryAddresses', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($channelUrls)) {
            array_push($this->openAPINullablesSetToNull, 'channelUrls');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('channelUrls', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setOrganizationId($organizationId)
    {
        ...
        if ((mb_strlen($organizationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $organizationId when calling V10VmOpenApiPrintableFormChannelIn., must be bigger than or equal to 1.');
        }
    ...
    public function setPublishingStatus($publishingStatus)
    {
        ...
        if ((mb_strlen($publishingStatus) < 1)) {
            throw new \InvalidArgumentException('invalid length for $publishingStatus when calling V10VmOpenApiPrintableFormChannelIn., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param bool|null $deleteAllDeliveryAddresses Set to true to delete all existing delivery addresses for the service channel. The DeliveryAddresses should be empty when this property is set to true.
     *
     * @return self
     */
    public function setDeleteAllDeliveryAddresses($deleteAllDeliveryAddresses)
    {
        if (is_null($deleteAllDeliveryAddresses)) {
            throw new \InvalidArgumentException('non-nullable deleteAllDeliveryAddresses cannot be null');
        }
     ...
     *
     * @param bool|null $deleteAllChannelUrls Set to true to delete all existing channel urls for the service channel. The ChannelUrls collection should be empty when this property is set to true.
     *
     * @return self
     */
    public function setDeleteAllChannelUrls($deleteAllChannelUrls)
    {
        if (is_null($deleteAllChannelUrls)) {
            throw new \InvalidArgumentException('non-nullable deleteAllChannelUrls cannot be null');
        }
     ...
     *
     * @param bool|null $deleteAllAttachments Set to true to delete all existing attachments for the service channel. The Attachments collection should be empty when this property is set to true.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $deleteAllFormIdentifiers Set to true to delete all existing form identifiers for the service channel. The form identifiers collection should be empty when this property is set to true.
     *
     * @return self
     */
    public function setDeleteAllFormIdentifiers($deleteAllFormIdentifiers)
    {
        if (is_null($deleteAllFormIdentifiers)) {
            throw new \InvalidArgumentException('non-nullable deleteAllFormIdentifiers cannot be null');
        }
