...
/**
 * V11VmOpenApiServiceLocationChannel Class Doc Comment
 *
 * @category Class
 ...
 */
class V11VmOpenApiServiceLocationChannel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V11VmOpenApiServiceLocationChannel';
    ...
    */
    ...
    public function setSourceId($sourceId)
    {
        ...
        if (!is_null($sourceId) && (!preg_match("/^[A-Za-z0-9-.]*$/", $sourceId))) {
            throw new \InvalidArgumentException("invalid value for \$sourceId when calling V11VmOpenApiServiceLocationChannel., must conform to the pattern /^[A-Za-z0-9-.]*$/.");
        }
     ...
     * Sets oid
     *
     * @param string|null $oid Service channel OID. Must match the regex @\"^[A-Za-z0-9.-]*$\".
     *
     * @return self
     */
    public function setOid($oid)
    {
        ...
        if (!is_null($oid) && (!preg_match("/^[A-Za-z0-9.-]*$/", $oid))) {
            throw new \InvalidArgumentException("invalid value for \$oid when calling V11VmOpenApiServiceLocationChannel., must conform to the pattern /^[A-Za-z0-9.-]*$/.");
        }
     ...
     * Sets phoneNumbers
     *
     * @param \Tampere\PtvV11\PtvModel\V4VmOpenApiPhoneWithType[]|null $phoneNumbers List of phone numbers for the service channel. Includes also fax numbers.
     *
     * @return self
     */
     ...
     * Gets addresses
     *
     * @return \Tampere\PtvV11\PtvModel\V9VmOpenApiAddressLocation[]|null
     */
     ...
     * Sets addresses
     *
     * @param \Tampere\PtvV11\PtvModel\V9VmOpenApiAddressLocation[]|null $addresses List of service location addresses.
     *
     * @return self
     */
