 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V11VmOpenApiPhoneChannelIn implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'V11VmOpenApiPhoneChannelIn';
...
'deleteAllSupportPhones' => 'getDeleteAllSupportPhones'    ];
     ...
     *
     * @param string[] $requiredPropertiesAvailableLanguages Internal property to check the languages within required lists: ServiceChannelNames, ServiceChannelDescriptions  and PhoneNumbers lists.
     *
     * @return $this
     */
     ...
     * Sets phoneNumbers
     *
     * @param \Tampere\PtvV11\PtvModel\V4VmOpenApiPhoneWithType[] $phoneNumbers List of support phone numbers for the service channel.
     *
     * @return $this
     */
     ...
     *
     * @param bool $deleteAllSupportEmails Set to true to delete all existing support emails for the service channel. The SupportEmails collection should be empty when this property is set to true.
     *
     * @return $this
     */
     ...
     *
     * @param bool $deleteAllSupportPhones Set to true to delete all existing support phonesfor the service channel. The SupportPhones collection should be empty when this property is set to true.
     *
     * @return $this
     */
