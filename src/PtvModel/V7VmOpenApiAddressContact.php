 ...
 */
class V7VmOpenApiAddressContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V7VmOpenApiAddressContact';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Address type, Postal.
     *
     * @return self
     */
     ...
     * Sets subType
     *
     * @param string|null $subType Address sub type, Street, PostOfficeBox or Abroad.
     *
     * @return self
     */
