...
/**
 * V11VmOpenApiPhoneChannelInBase Class Doc Comment
 *
 * @category Class
 ...
 */
class V11VmOpenApiPhoneChannelInBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V11VmOpenApiPhoneChannelInBase';
    ...
    */
    ...
    public function setSourceId($sourceId)
    {
        ...
        if (!is_null($sourceId) && (!preg_match("/^[A-Za-z0-9-.]*$/", $sourceId))) {
            throw new \InvalidArgumentException("invalid value for \$sourceId when calling V11VmOpenApiPhoneChannelInBase., must conform to the pattern /^[A-Za-z0-9-.]*$/.");
        }
    ...
    public function setPublishingStatus($publishingStatus)
    {
        ...
        if ((mb_strlen($publishingStatus) < 1)) {
            throw new \InvalidArgumentException('invalid length for $publishingStatus when calling V11VmOpenApiPhoneChannelInBase., must be bigger than or equal to 1.');
        }
