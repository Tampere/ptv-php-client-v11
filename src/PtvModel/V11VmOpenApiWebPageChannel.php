 ...
 */
class V11VmOpenApiWebPageChannel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V11VmOpenApiWebPageChannel';
    ...
    */
    ...
    public function setSourceId($sourceId)
    {
        ...
        if (!is_null($sourceId) && (!preg_match("/^[A-Za-z0-9-.]*$/", $sourceId))) {
            throw new \InvalidArgumentException("invalid value for \$sourceId when calling V11VmOpenApiWebPageChannel., must conform to the pattern /^[A-Za-z0-9-.]*$/.");
        }
     ...
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiAccessibilityClassification[]|null $accessibilityClassification The accessibility classification level.
     *
     * @return self
     */
