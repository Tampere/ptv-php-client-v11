...
/**
 * V10VmOpenApiPrintableFormChannelInBase Class Doc Comment
 *
 * @category Class
 ...
 */
class V10VmOpenApiPrintableFormChannelInBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V10VmOpenApiPrintableFormChannelInBase';
    ...
    */
    ...
    public function setSourceId($sourceId)
    {
        ...
        if (!is_null($sourceId) && (!preg_match("/^[A-Za-z0-9-.]*$/", $sourceId))) {
            throw new \InvalidArgumentException("invalid value for \$sourceId when calling V10VmOpenApiPrintableFormChannelInBase., must conform to the pattern /^[A-Za-z0-9-.]*$/.");
        }
     ...
     * Sets channelUrls
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLocalizedListItem[]|null $channelUrls List of localized channel urls. Possible type values are: PDF, DOC, Excel. (Max.Length: 500).
     *
     * @return self
     */
     ...
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLocalizedListItem[]|null $serviceChannelDescriptions List of localized service channel descriptions. Possible type values are: Description, Summary. (Max.Length: 150 Summary).
     *
     * @return self
     */
    ...
    public function setPublishingStatus($publishingStatus)
    {
        ...
        if ((mb_strlen($publishingStatus) < 1)) {
            throw new \InvalidArgumentException('invalid length for $publishingStatus when calling V10VmOpenApiPrintableFormChannelInBase., must be bigger than or equal to 1.');
        }
