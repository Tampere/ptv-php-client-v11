 ...
 */
class VmOpenApiExpiringTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VmOpenApiExpiringTask';
    ...
    */
     ...
     * Sets expires
     *
     * @param \DateTime|null $expires Date when item is expiring (UTC).
     *
     * @return self
     */
