 ...
 */
class V9VmOpenApiAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V9VmOpenApiAddress';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Address type, Visiting or Postal.
     *
     * @return self
     */
     ...
     * Sets subType
     *
     * @param string|null $subType Address sub type, Street, PostOfficeBox, Foreign or Other.
     *
     * @return self
     */
