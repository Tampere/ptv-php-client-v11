 ...
 */
class V4VmOpenApiLaw implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V4VmOpenApiLaw';
    ...
    */
     ...
     * Sets names
     *
     * @param \Tampere\PtvV11\PtvModel\VmOpenApiLanguageItem[]|null $names List of localized law names. (Max.Length: 500).
     *
     * @return self
     */
     ...
     * Sets orderNumber
     *
     * @param int|null $orderNumber Gets or sets the owner reference identifier.
     *
     * @return self
     */
