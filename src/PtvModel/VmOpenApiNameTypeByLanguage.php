...
/**
 * VmOpenApiNameTypeByLanguage Class Doc Comment
 *
 * @category Class
 ...
 */
class VmOpenApiNameTypeByLanguage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VmOpenApiNameTypeByLanguage';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type DisplayNameType preferred by language code (Name or Alternative/AlternateName).
     *
     * @return self
     */
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling VmOpenApiNameTypeByLanguage., must be bigger than or equal to 1.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) < 1)) {
            throw new \InvalidArgumentException('invalid length for $language when calling VmOpenApiNameTypeByLanguage., must be bigger than or equal to 1.');
        }
