...
/**
 * V4VmOpenApiPhoneWithType Class Doc Comment
 *
 * @category Class
 ...
 */
class V4VmOpenApiPhoneWithType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V4VmOpenApiPhoneWithType';
    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling V4VmOpenApiPhoneWithType., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d{1,20}$/", $number))) {
            throw new \InvalidArgumentException("invalid value for \$number when calling V4VmOpenApiPhoneWithType., must conform to the pattern /^\\d{1,20}$/.");
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) < 1)) {
            throw new \InvalidArgumentException('invalid length for $language when calling V4VmOpenApiPhoneWithType., must be bigger than or equal to 1.');
        }
    ...
    public function setAdditionalInformation($additionalInformation)
    {
        ...
        if (!is_null($additionalInformation) && (mb_strlen($additionalInformation) > 150)) {
            throw new \InvalidArgumentException('invalid length for $additionalInformation when calling V4VmOpenApiPhoneWithType., must be smaller than or equal to 150.');
        }
    ...
    public function setChargeDescription($chargeDescription)
    {
        ...
        if (!is_null($chargeDescription) && (mb_strlen($chargeDescription) > 150)) {
            throw new \InvalidArgumentException('invalid length for $chargeDescription when calling V4VmOpenApiPhoneWithType., must be smaller than or equal to 150.');
        }
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling V4VmOpenApiPhoneWithType., must be bigger than or equal to 1.');
        }
