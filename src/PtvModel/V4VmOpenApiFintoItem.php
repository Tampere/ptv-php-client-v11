 ...
 */
class V4VmOpenApiFintoItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V4VmOpenApiFintoItem';
    ...
    */
     ...
     * Sets newUri
     *
     * @param string|null $newUri New URI from Y-platform.
     *
     * @return self
     */
     ...
     * Sets newParentUri
     *
     * @param string|null $newParentUri New parent URI from Y-platform.
     *
     * @return self
     */
