...
/**
 * V7VmOpenApiAddressContactIn Class Doc Comment
 *
 * @category Class
 ...
 */
class V7VmOpenApiAddressContactIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V7VmOpenApiAddressContactIn';
    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (!preg_match("/^[A-Z]{2}$/", $country))) {
            throw new \InvalidArgumentException("invalid value for \$country when calling V7VmOpenApiAddressContactIn., must conform to the pattern /^[A-Z]{2}$/.");
        }
     ...
     * Sets type
     *
     * @param string $type Address type, only Postal accepted.
     *
     * @return self
     */
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling V7VmOpenApiAddressContactIn., must be bigger than or equal to 1.');
        }
    ...
    public function setSubType($subType)
    {
        ...
        if ((mb_strlen($subType) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subType when calling V7VmOpenApiAddressContactIn., must be bigger than or equal to 1.');
        }
