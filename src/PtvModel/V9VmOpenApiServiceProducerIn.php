 ...
 */
class V9VmOpenApiServiceProducerIn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'V9VmOpenApiServiceProducerIn';
    ...
    */
    ...
    public function setProvisionType($provisionType)
    {
        ...
        if ((mb_strlen($provisionType) < 1)) {
            throw new \InvalidArgumentException('invalid length for $provisionType when calling V9VmOpenApiServiceProducerIn., must be bigger than or equal to 1.');
        }
     ...
     * Sets organizations
     *
     * @param string[]|null $organizations Gets or sets the organization id information.
     *
     * @return self
     */
